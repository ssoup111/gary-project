...
export default function AdminNav() {
  return (
    <div className="mb-8 flex flex-wrap gap-3">
      ...
      <Link href="/admin/stats" className="rounded-xl border border-zinc-700 px-4 py-2 text-sm font-black text-white hover:border-amber-400">Stats</Link>
      ...
      <Link href="/admin/delivery" className="rounded-xl border border-zinc-700 px-4 py-2 text-sm font-black text-white hover:border-amber-400">Delivery</Link>
      ...
      <Link href="/admin/subscriptions" className="rounded-xl border border-zinc-700 px-4 py-2 text-sm font-black text-white hover:border-amber-400">
        Subscriptions
      </Link>
