  ...
  return (
    <main className="min-h-screen bg-[#FAF8F5] px-6 py-16 text-[#0A3161]">
      <div className="mx-auto max-w-4xl">
        ...
        {/* Prohibited */}
        <section className="mt-8 rounded-3xl border border-red-900/40 bg-red-50/20 p-8">
        ...
        {/* Minors callout */}
        <section className="mt-8 rounded-3xl border border-[#A6412B]/30 bg-[#A6412B]/10 p-6">
          <h2 className="text-lg font-black text-[#A6412B]">Zero Tolerance: Minors</h2>
