    ...
    <main className="min-h-screen bg-[#FAF8F5] px-6 py-16 text-[#0A3161]">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mt-10 space-y-8 leading-8 text-[#0A3161]/78">
          ...
          <section>
            <h2 className="text-2xl font-black text-[#0A3161]">3. How We Use Your Information</h2>
            <ul className="mt-3 space-y-2 pl-4">
          ...
          <section>
            <h2 className="text-2xl font-black text-[#0A3161]">5. Data Retention</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-2xl font-black text-[#0A3161]">6. Security</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-2xl font-black text-[#0A3161]">7. Children's Privacy</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-2xl font-black text-[#0A3161]">8. Your Rights</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-2xl font-black text-[#0A3161]">9. Changes to This Policy</h2>
            <p className="mt-3">
          ...
          <section>
            ...
            <p className="mt-3">
              ...
              <a href="mailto:ssoup1@gmail.com" className="text-[#A6412B] underline hover:text-[#A6412B]">ssoup1@gmail.com</a>.
            </p>
          </section>
